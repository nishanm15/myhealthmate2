    ...
    <div className="p-4 sm:p-6 max-w-7xl mx-auto">
      ...
      >
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Monthly Summary</h1>
            <p className="text-gray-600">Comprehensive overview of your health journey</p>
          </div>
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full sm:w-auto">
            <button
              onClick={exportToCSV}
              className="flex items-center justify-center px-4 py-2 min-h-[44px] bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium transition-colors"
            >
            ...
            <button
              ...
              className="flex items-center justify-center px-4 py-2 min-h-[44px] bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-colors"
            >
              <Download className="w-4 h-4 mr-2 flex-shrink-0" />
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            ...
            >
              ...
              <p className="text-2xl sm:text-3xl font-bold text-gray-900">{monthlyData.workouts.total}</p>
            ...
            >
              ...
              <p className="text-2xl sm:text-3xl font-bold text-gray-900">{monthlyData.meals.total}</p>
              <p className="text-sm text-gray-500 mt-1">
